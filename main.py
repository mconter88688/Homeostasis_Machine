...
hs_model.FSM.states["TrainingImageModel"] = states.TrainingModel(cons.FEEDBACK_FILE, cons.IMAGE_MODEL_PATH, hs_model.FSM, model_data, image_model_params, image_autoencoder, name_of_model= "IMAGE")
hs_model.FSM.states["TrainingLDRDModel"] = states.TrainingModel(cons.FEEDBACK_FILE, cons.LDRD_MODEL_PATH, hs_model.FSM, model_data,  ldrd_model_params, ldrd_autoencoder, name_of_model= "LDRD")

...
hs_model.FSM.states["DataIntake"] = states.DataIntake(hs_model.FSM, model_data, allsensors, image_autoencoder, ldrd_autoencoder)
hs_model.FSM.states["RealTimeDetection"] = states.RealTimeDetection(hs_model.FSM, model_data, allsensors, image_autoencoder, ldrd_autoencoder)
...
hs_model.FSM.transitions["toDataIntake"] = fsm.Transition("DataIntake")
hs_model.FSM.transitions["toRealTimeDetection"] = fsm.Transition("RealTimeDetection")
